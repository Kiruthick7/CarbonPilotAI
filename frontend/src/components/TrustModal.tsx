    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 print:hidden">
      ...
      >
        <div className="bg-emerald-50 p-6 border-b border-emerald-100 flex items-center justify-between">
          <h2 id="trust-modal-title" className="text-xl font-bold text-emerald-900 flex items-center gap-2">
        ...
        <div className="p-8 space-y-8 max-h-[70vh] overflow-y-auto">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-slate-900 mb-1">Zero Data Retention</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                Your utility bills contain sensitive data. That&apos;s why CarbonPilot AI processes your files in-memory and <strong>instantly deletes them</strong> once the data is extracted. We never store, train on, or retain your documents.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-slate-900 mb-1">Deterministic Math, Not Hallucinations</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                AI is terrible at math. We <strong>never</strong> use LLMs to calculate your carbon footprint. All emissions are calculated using deterministic, verifiable formulas based on standard EPA and DEFRA emissions factors.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-slate-900 mb-1">AI Used Responsibly</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                We only use LLMs for tasks they excel at: parsing messy OCR text, generating personalized climate strategies, and powering the natural language simulator. The core logic remains entirely deterministic and transparent.
              </p>
            </div>
          </div>
        </div>
