...
const getApiUrl = () => process.env.NEXT_PUBLIC_API_URL || "http://127.0.0.1:8000/v1";
...
export const carbonApi = {
  ...
  fetchRankedActions: async (inventory: CarbonInventory, profile: CarbonProfile, constraints: Record<string, unknown> = {}) => {
