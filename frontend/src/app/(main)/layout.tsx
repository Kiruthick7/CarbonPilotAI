...
export default function MainLayout({
  ...
  return (
    <div className="flex h-screen bg-gray-50 text-gray-900 overflow-hidden">
        ...
        <div className="p-6">
          <Link href="/">
            <div className="flex items-center gap-2 cursor-pointer group">
              <Image src="/logo.png" unoptimized width={36} height={36} alt="CarbonPilot Logo" className="w-9 h-9 object-contain drop-shadow-sm" />
      ...
      <TrustModal isOpen={isTrustModalOpen} onClose={() => setIsTrustModalOpen(false)} />
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] z-50 flex justify-around items-center p-2 pb-safe">
        <Link href="/" className={`flex flex-col items-center p-2 rounded-lg transition-colors ${pathname === '/' ? 'text-emerald-600' : 'text-gray-500 hover:bg-gray-50'}`}>
        ...
        <Link href="/dashboard" className={`flex flex-col items-center p-2 rounded-lg transition-colors ${pathname === '/dashboard' ? 'text-emerald-600' : 'text-gray-500 hover:bg-gray-50'}`}>
          <svg className="w-6 h-6 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" /></svg>
          <span className="text-[10px] font-bold">Dashboard</span>
        </Link>
        <Link href="/actions" className={`flex flex-col items-center p-2 rounded-lg transition-colors ${pathname === '/actions' ? 'text-emerald-600' : 'text-gray-500 hover:bg-gray-50'}`}>
          <svg className="w-6 h-6 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>
          <span className="text-[10px] font-bold">Actions</span>
        </Link>
        <Link href="/simulator" className={`flex flex-col items-center p-2 rounded-lg transition-colors ${pathname === '/simulator' ? 'text-emerald-600' : 'text-gray-500 hover:bg-gray-50'}`}>
        ...
        <button onClick={() => setIsTrustModalOpen(true)} className={`flex flex-col items-center p-2 rounded-lg transition-colors text-gray-500 hover:bg-gray-50`}>
