    ...
    <div className="min-h-screen bg-slate-50 flex flex-col text-slate-900 font-sans selection:bg-emerald-200">
      <header className="px-8 py-6 flex justify-between items-center bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-slate-200/50">
        <div className="flex items-center gap-2">
          ...
          <div className="text-2xl font-black tracking-tight text-slate-800">
            CarbonPilot <span className="text-emerald-500">AI</span>
          </div>
        </div>
        <Link
          href="/onboarding"
          className="bg-slate-900 text-white px-6 py-2.5 rounded-full font-semibold text-sm hover:bg-slate-800 transition-all shadow-sm hover:shadow-md"
        >
          Get Started
        </Link>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 py-32 relative overflow-hidden">
        ...
        <p className="text-xl md:text-2xl text-slate-500 max-w-3xl mb-12 leading-relaxed">
          Stop guessing your carbon footprint. Upload your utility bills, get
          deterministic action plans, and simulate your path to Net Zero with AI
          Copilot guidance.
        </p>
        <div className="flex gap-4 items-center">
          <Link
            href="/onboarding"
            className="bg-emerald-500 text-white px-10 py-5 rounded-full text-lg font-bold hover:bg-emerald-600 transition-all shadow-xl shadow-emerald-500/20 hover:shadow-emerald-500/40 hover:-translate-y-1 transform"
          >
            Start Your Assessment
          </Link>
          <a
            href="#features"
            className="px-10 py-5 rounded-full text-lg font-bold text-slate-600 hover:bg-slate-100 transition-colors"
          >
            Learn More
          </a>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-left">
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl hover:shadow-slate-200/50 transition-all group">
              ...
              <p className="text-slate-500 leading-relaxed">
                Your personal information never leaves your device. We extract
                utility data entirely locally using browser-safe OCR.
              </p>
            </div>
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl hover:shadow-slate-200/50 transition-all group">
              <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-sm mb-6 border border-slate-100 group-hover:scale-110 transition-transform">
              ...
              <p className="text-slate-500 leading-relaxed">
                No AI hallucinations. We use strict, transparent math to
                calculate exact ROI and real-world carbon reduction potential.
              </p>
            </div>
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:shadow-xl hover:shadow-slate-200/50 transition-all group">
              <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-sm mb-6 border border-slate-100 group-hover:scale-110 transition-transform">
              ...
              <p className="text-slate-500 leading-relaxed">
                Have questions about an action? Our embedded Copilot synthesizes
                local constraints and guides you step-by-step.
              </p>
            </div>
          </div>
        </div>
